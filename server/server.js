...
app.use(
  cors({
    origin: "http://192.168.0.200:1342",
    credentials: true,
...
app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "http://192.168.0.200:1342");
...
function authMiddleware(req, res, next) {
  ...
  if (clientIP !== "http://192.168.0.200:1342") {
    return res.redirect("http://192.168.0.200:1342/*");
  }
...
// server.listen(PORT, () => {
//   console.log(`http://192.168.0.200:${PORT}`);
// });

server.listen(PORT, "192.168.0.200", () => {
  console.log(`http://192.168.0.200:${PORT}`);
});
